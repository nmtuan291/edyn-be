...
namespace ForumService.ForumService.Application.Interfaces.Services
{
    public interface IForumService
    {
        ...
        Task<ForumDto?> GetForum(Guid userId, string forumName, CancellationToken cancellationToken = default);
        ...
        ValueTask<List<ForumDto>> GetRecentVisitForums(Guid userId, CancellationToken cancellationToken = default);
    }
}
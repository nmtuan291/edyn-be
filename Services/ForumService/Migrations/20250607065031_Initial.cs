        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ForumBanner = table.Column<string>(type: "text", nullable: false),
                    ForumImage = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ForumUser", x => new { x.UserId, x.ForumId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ForumThreadId = table.Column<Guid>(type: "uuid", nullable: true)
                },
                constraints: table =>
                {
